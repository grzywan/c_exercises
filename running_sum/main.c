...
void calc_run_sum(double *sig_src_arr, double *sig_dest_arr, int sig_length);
...
int main()
{
    FILE *input_sig_fptr,*output_sig_fptr;
     ...
     calc_run_sum((double *)&InputSignal_f32_1kHz_15kHz[0],(double *)&Output_signal[0], (int)SIG_LENGTH);
